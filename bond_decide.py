...
class IC(object):
    ...
    Arguments:
     ...
     | ``internal_coordinates`` Contain instances of different kinds of internal_coordinates class
    ...
    def add_bond(self, atom1, atom2, type):
        ...
        if bond_object.atoms in self.atoms:
            ...
            return
        self.internal_coordinates.append(bond_object) 
    ...
    def add_angle(self, atom1, atom2, atom3):
        ...
        if angle_object.atoms in self.atoms:
            ...
            return
        self.internal_coordinates.append(angle_object)
    ...
    def _add_dihed_dot(self, atom1, atom2, atom3, atom4):
        ...
        self.internal_coordinates.append(dihed_object)
...
if __name__ == '__main__':
    ...
    print ic_object.B_matrix.shape
    print ic_object.internal_coordinates[4].value
