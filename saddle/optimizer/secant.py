...
def secant_1(new_ob, old_ob):
    ...
    delta_v = new_ob.vspace - old_ob.vspace
    delta_b = new_ob.b_matrix - old_ob.b_matrix
    part1 = np.dot(np.dot(old_ob.b_matrix.T, delta_v),
                   old_ob.v_gradient)  # v_space gradient here is cartesian
...
def secant_2(new_ob, old_ob):
    ...
    part1 = np.dot(np.dot(old_ob.vspace.T, delta_inv_b.T),
                   old_ob.x_gradient)  # v_space gradient here is cartesian
