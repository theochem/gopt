...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.gridLayout.addWidget(self.view_vmd, 11, 0, 1, 1)
        ...
        self.gridLayout.addWidget(self.tc_progressBar, 8, 0, 1, 2)
        self.ts_guess = QtGui.QPushButton(self.centralwidget)
        self.ts_guess.setObjectName(_fromUtf8("ts_guess"))
        self.gridLayout.addWidget(self.ts_guess, 8, 2, 1, 1)
        self.select_key_ic = QtGui.QPushButton(self.centralwidget)
        self.select_key_ic.setObjectName(_fromUtf8("select_key_ic"))
        self.gridLayout.addWidget(self.select_key_ic, 8, 3, 1, 1)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.select_key_ic.setText(_translate("MainWindow", "Select Key IC", None))
