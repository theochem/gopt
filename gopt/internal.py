...
from gopt.errors import (
    AtomsIndexError,
    AtomsNumberError,
    NotConvergeError,
    NotSetError,
)
from gopt.math_lib import pse_inv
from gopt.molmod import bend_angle, dihed_angle
from gopt.opt import GeoOptimizer, Point
from gopt.periodic.periodic import periodic
...
class Internal(Cartesian):
    ...
    #                 raise NotConvergeError(
    #                     "Converge to gopt point, need to change optimizer"
    #                 )
