...
import numpy as np
from gopt.optimizer.optloop import OptLoop
from gopt.optimizer.quasi_newton import QuasiNT
from gopt.optimizer.secant import secant
from gopt.optimizer.trust_radius import TrustRegion
...
class TestOptLoop(TestCase):
    def setUp(self):
        with path("gopt.optimizer.test.data", "water.xyz") as mol_path:
    ...
    def setup_opt(self):
        ...
        with path("gopt.optimizer.test.data", "water_old.fchk") as fchk_file:
    ...
    def test_verify_new_point(self):
        ...
        with path("gopt.optimizer.test.data", "new_step_water.fchk") as fchk_file:
    ...
    def test_one_complete_opt_loop(self):
        ...
        with path("gopt.optimizer.test.data", "final_water.fchk") as fchk_file:
