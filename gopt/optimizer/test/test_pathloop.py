...
import numpy as np
from gopt.optimizer.pathloop import PathLoop
from gopt.optimizer.react_point import ReactPoint
from gopt.optimizer.hessian_modify import modify_hessian_with_pos_defi
...
class TestPathLoop(TestCase):
    def setUp(self):
        with path("gopt.optimizer.test.data", "HNCS.xyz") as rct_f:
            with path("gopt.optimizer.test.data", "HSCN.xyz") as prd_f:
        ...
        with path("gopt.optimizer.test.data", "pathloop_hscn.fchk") as fchk_f:
