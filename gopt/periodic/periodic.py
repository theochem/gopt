...
from gopt.periodic.units import amu, angstrom
...
def load_periodic():
    """Load the elements for the periodic table.

    Returns
    -------
    Periodic
        a periodic table with all the existing elements from database
    """
    convertor_types = {
        "int": (lambda s: int(s)),
