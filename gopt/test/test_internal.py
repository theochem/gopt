...
from gopt.coordinate_types import DihedralAngle
from gopt.internal import Internal
from gopt.molmod import dihed_angle
from gopt.opt import Point
...
class TestInternal(unittest.TestCase):
    ...
    #     with path("gopt.test.data", "o2h4_plane.xyz") as mol_path:
    #         mol = Utils.load_file(mol_path)
    ...
    def test_h_bond(self):
        with path("gopt.test.data", "di_water.xyz") as mol_path:
            mol = Internal.from_file(mol_path, charge=0, multi=1)
    ...
    def test_mini_dihed(self):
        ...
        with path("gopt.test.data", "ethane.xyz") as mol2_path:
